...
for files in os.listdir('D:/bot/zchatbot/chatterbot-corpus-master\chatterbot_corpus\data\english/'):
    data = open('D:/bot/zchatbot/chatterbot-corpus-master\chatterbot_corpus\data\english/' + files, 'r').readlines()
    bot.train(data)
